...
class Queue<Item> implements Iterable<Item> {
    /**
     * declaration of first node.
     */
    private Node<Item> first;    //beginning of queue

    /**
     * declaration of last node.
     */
...
class BinarySearchST<Key extends Comparable<Key>, Value> {
    ...
    **/
    ...
    /**
     * Returns the number of keys in this symbol table strictly
     * less than {@code key}.
     *
     * @param  key the key
     * @return the number of keys in the symbol table strictly
     * less than {@code key}
     * @throws IllegalArgumentException if {@code key} is {@code null}
     */
    ...
    /**
     * Returns the largest key in this symbol table less than or equal
     * to {@code key}.
     *
     * @param  key the key
    ...
    /**
     * Returns the smallest key in this symbol table greater than or
     * equal to {@code key}.
     *
     * @param  key the key
     * @return the smallest key in this symbol table greater than or
     * equal to {@code key}
     * @throws NoSuchElementException if there is no such key
     * @throws IllegalArgumentException if {@code key} is {@code null}
     */
